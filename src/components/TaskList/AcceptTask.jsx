  ...
  return (
        <div className='h-full w-[327px] p-5 flex-shrink-0 bg-slate-800 rounded-xl'>
            ...
            <div className='flex justify-between mt-9 text-white'>
                <button className='bg-green-500 py-1 px-2 text-sm rounded-md active:scale-95 duration-200'>Mark Completed</button>
                <button className='bg-red-500 py-1 px-2 text-sm rounded-md active:scale-95 duration-200'>Mark Failed</button>
            </div>
        </div>
  )
}
